    ...
    return (
        <section className='flex-between bg-white py-4 px-6'>
            <section className="flexx space-x-10">
                <h2 className='text-lg font-medium text-gray-700'>Keanggotaan</h2>
                <div className='flexx space-x-2 w-[450px] rounded-[100px] border border-gray-200 px-4'>
                    ...
                    <input type="text" placeholder='Cari anggota...' className='flex-1 border-none ring-0 focus:ring-0 outline-none bg-transparent'/>
                </div>
            </section>
